...
export default class BottomTabNavigator extends Component {
  ...
  changeUpdated=()=>{
    this.changeUpdated.setState{isUpdating({isUpdated: true})}
  }
  changeRemoved=()=>{
    this.changeRemoved.setState{isRemoving({isRemoved: false})}
  }
  componentDidMount() {
    let theme;
    firebase
  ...
  renderStory=(props)=>{
    return <CreateStory setUpdateToFalse={this.removeUpdated}{...props}/>
  }
  render() {
    return (
      <Tab.Navigator
